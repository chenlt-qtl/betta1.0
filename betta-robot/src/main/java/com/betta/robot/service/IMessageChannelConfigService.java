 ...
 * @author betta
 */
public interface IMessageChannelConfigService {
    ...
    /**
     * 根据渠道类型查询启用的一条（用于回调发消息）
     *
     * @param channelType FEISHU / WECHAT
     * @return 配置，可能为 null
     */
    MessageChannelConfig selectOneEnabledByChannel(String channelType);
